...
const BookAddForm = () => {
 ...
 const handleSubmit = async (e) => {
  ...
  return (
<form onSubmit={handleSubmit} className="text-black w-full max-w-4xl mx-auto p-6 bg-white rounded shadow-md space-y-4">
  {/* Row 1: Title + Author */}
  ...
  <select
    ...
    required
    className="w-full md:w-[32%] border border-gray-300 rounded px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
  >
  ...
  <input
    ...
    className="w-full md:w-[32%] border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
  />
</div>
  {/* Row 5: Textarea */}
  <div>
